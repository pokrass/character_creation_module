...
def attack(char_name: str, char_class: str) -> str:
    """Return a random number of damage points."""
...
def defence(char_name: str, char_class: str) -> str:
    """Return a random number of defence points."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Return a random number of special skill points."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Offer to choose the type of training."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Offer to enter a name and choose a character class."""
    approve_choice: str = ''
    char_class: str = ''
